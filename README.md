...
- **Google Cloud Identity Groups API + People API** — expands Google Group invitees into individual people and resolves their display names and (optional, see "Show attendee photos" in settings) photos, from your Workspace directory and from your Google "Other contacts" (people you've corresponded with over Gmail) — read-only; see [Setup](docs/setup.md).
